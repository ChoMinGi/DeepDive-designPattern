...
public class GiftCardAdminController {
    ...
    public ResponseEntity<?> manageTaggedCard(@Valid @RequestBody GiftCardAdminRequest.GiftCardTransactionDTO giftCardTransactionDTO) {
        paymentArchiveService.savePaymentArchive(giftCardCommandService.transactGiftCard(giftCardTransactionDTO).convertToPaymentArchive(giftCardTransactionDTO.phoneNumber()));
