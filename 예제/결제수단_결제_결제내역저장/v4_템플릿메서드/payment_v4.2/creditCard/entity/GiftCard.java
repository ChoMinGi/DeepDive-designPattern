...
@NoArgsConstructor
@AllArgsConstructor
public class GiftCard extends BaseEntity implements DaynerPayment, PaymentArchivable {
    ...
    @Override
    public PaymentArchive convertToPaymentArchive(String phoneNumber, String description, int balance) {
        return PaymentArchive.builder()
                .paymentType(PaymentType.GIFT_CARD)
                .phoneNumber(phoneNumber)
                .identificationNumber(cardNumber)
                .amount(balance) // ok~
                .date(getUpdatedAt()) //ok~
