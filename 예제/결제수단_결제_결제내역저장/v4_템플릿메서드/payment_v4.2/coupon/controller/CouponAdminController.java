...
public class CouponAdminController {
    ...
    public ResponseEntity<?> manageTaggedCoupon(@Valid @RequestBody CouponAdminRequest.CouponUsageDTO couponUsageDTO) {
        paymentArchiveService.savePaymentArchive(couponCommandService.usingCoupon(couponUsageDTO).convertToPaymentArchive(couponUsageDTO.phoneNumber(),"쿠폰 사용",couponUsageDTO.usageAmount()));
