...
@Component
public class PaymentArchiveFactory {
    ...
    @Autowired
    public PaymentArchiveFactory(PaymentArchiveRepository paymentArchiveRepository, List<PaymentArchiveStrategy<?>> strategies) {
    ...
    public void savePaymentArchiveFromGiftCard(List<GiftCardTransaction> giftCardTransactionList, String phoneNumber) {
        ...
        List<PaymentArchive> archives = giftCardTransactionList.stream()
                .map(transaction -> strategy.convertToArchive(transaction, phoneNumber))
    ...
    public void savePaymentArchiveFromCoupon(Coupon coupon, String phoneNumber) {
        ...
        PaymentArchive archive = strategy.convertToArchive(coupon, phoneNumber);
