...
public class GiftCardCommandService {
    ...
    private GiftCardAdminResponse.GiftCardAdminDTO activateGiftCardAndProcessTransaction(GiftCardAdminRequest.GiftCardActiveDTO giftCardsActiveDTO) {
        ...
        processGiftCardTransaction(giftCard, giftCardsActiveDTO.balance(), TransactionType.CHARGE).convertToPaymentArchive(giftCard.getBuyer());
        return new GiftCardAdminResponse.GiftCardAdminDTO(giftCard);
    }

    @Transactional
    public GiftCardTransaction transactGiftCard(GiftCardAdminRequest.GiftCardTransactionDTO giftCardTransactionDTO) {
        ...
        return processGiftCardTransaction(giftCard, updatedAmount, transactionType);
    }

    private GiftCardTransaction processGiftCardTransaction(GiftCard giftCard, int amount, TransactionType transactionType) {
        GiftCardTransaction transaction = GiftCardTransaction.builder()
                ...
                .build();
        return giftCardTransactionRepository.save(transaction);
    }
